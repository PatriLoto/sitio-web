...
(function () {
  ...
  function applySettings(s) {
    ...
    //const container = document.getElementById('quarto-document-content.content') || body;
    const container = document.querySelector('#quarto-document-content.content') || body;
